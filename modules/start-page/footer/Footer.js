            ...
            <div className='container'>
                <div className={classes.wrapper}>
                    <div className={classes.contentWrapper}>
                        <a title="Logo" className={classes.logoWrapper} href="#">
                        ...
                        <nav className={classes.nav}>
                            ...
                            <li><a className={classes.link} title="Services" href="#">Services</a></li>
                            <li><a className={classes.link} title="Works" href="#">Works</a></li>
                            <li><a className={classes.link} title="About us" href="#">About us</a></li>
                            <li><a className={classes.link} title="Contacts" href="#">Contacts</a></li>
                            </ul>
                        </nav>

                        <div className={classes.socialBlock}>
                            <a title="Instagram" href='#' className={classes.instagram}>
                            ...
                            <a title="Facebook" href='#' className={classes.facebook}>
