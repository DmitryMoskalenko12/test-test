          ...
          <div className={classes.contentWrapper}>
            ...
            <nav className={classes.nav}>
              <ul className={classes.list}>
                <li>
                  <a className={classes.link} title='Services' href='#'>
                    Services
                  </a>
                </li>
                <li>
                  <a className={classes.link} title='Works' href='#'>
                    Works
                  </a>
                </li>
                <li>
                  <a className={classes.link} title='About us' href='#'>
                    About us
                  </a>
                </li>
                <li>
                  <a className={classes.link} title='Contacts' href='#'>
                    Contacts
                  </a>
                </li>
              </ul>
