...
const LinkUi = ({ clazz, text }) => {
  const initialGradient =
    'linear-gradient(90deg, #47F4B6 0%, #4CF3B7 24.5%, #51EBC3 53%, #56E4CD 81%, #49F0DC 100%)';
  const reverseGradient =
    'linear-gradient(90deg, #49F0DC 0%, #56E4CD 24.5%, #51EBC3 53%, #4CF3B7 81%, #47F4B6 100%)';
